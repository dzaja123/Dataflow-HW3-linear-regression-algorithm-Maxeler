 ...
 * \param [in] instream_vector1 The stream should be of size ((param_N * 2) * 4) bytes.
 * \param [in] instream_vector2 The stream should be of size ((param_N * 2) * 4) bytes.
 * \param [out] outstream_output The stream should be of size (param_N * 4) bytes.
 */
void Vectors(
	int32_t param_N,
	const uint32_t *instream_vector1,
	const uint32_t *instream_vector2,
...
typedef struct { 
	...
	const uint32_t *instream_vector1; /**<  [in] The stream should be of size ((param_N * 2) * 4) bytes. */
	const uint32_t *instream_vector2; /**<  [in] The stream should be of size ((param_N * 2) * 4) bytes. */
	uint32_t *outstream_output; /**<  [out] The stream should be of size (param_N * 4) bytes. */
} Vectors_actions_t;
